            ...
            <div id="form_container">
                <form action="forget1.php" method="post">
					...
					<div class="form-group">
                        <label for="inputEmail"><h5><b>Enter Your Email</b></h5></label><br>
					...
					<br>
					<div class="form-group">
                        <label for="inputPassword"><h5><b>Enter New Password</b></h5></label><br>
                        <input type="password" class="form-control" name="newpass" id="inputPassword" style="height: 40px; border: grey 2px solid; border-radius: 5px;" placeholder="New Password" required>
                    </div>
					<br>
                    <div class="form-group">
                        <label for="inputCpassword"><h5><b>Confirm Password</b></h5></label><br>
                        <input type="password" class="form-control" name="cpass" id="inputCpassword" style="height: 40px; border: grey 2px solid; border-radius: 5px;" placeholder="Confirm Password" required>
                    </div>
                    <br>
                    <center>
                    <button style="background-color: #008bde;
                                    ...
                                    text-align: center;
                                    font-weight: 600;
                                    width: 150px;" name="updatepass">Update Password
                    </button>
                    </center>
                </form>
            </div>
