...
<body class="bg" style="background-image: url('images/login.jpg');">
    ...
    <div class="max-width-container">
      <div class="login_wrap" id="login_container">
        ...
        <div id="google_button_container">
          <div id="google_img_container">
            <img src="images/google.webp" height="25" width="25" align="center">
          </div>
          <div id="google_content"><a href="#" style="size: 7;">Login With Google</a></div>
        </div>

        <!-- Rest of the fields -->
        <div id="form_container">
          	<div class="helper">
        		<div id="google_or"><p>OR</p></div>
          	</div>

		<form method="post">
		<div class="form-group">
            <label for="inputEmail">E-mail</label>
            <input type="email" class="form-control" name="email" id="inputEmail" style="height: 30px; border: grey 2px solid; border-radius: 5px;" placeholder="Email" required>
        </div>
        <div class="form-group ">
            <label for="inputPassword">Password</label>
            <input type="password" class="form-control" name ="password" id="inputPassword" style="height: 30px; border: grey 2px solid; border-radius: 5px;" placeholder="Password" required>
        </div>
          	<p>
            	<span><a href="fpass.php">Forget password ?</a></span>
          	</p>
			  ...
			  text-align: center;
			  font-weight: 600;
			  width: 350px;">Login</button>
          	</form>
			<p>
            	New to Internshala ?
            <span><a href="register1.php">Signup</a></span>
          	</p>
        </div>
    </div>
</div>
