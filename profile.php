...
<ul class="list-group list-group-flush">
  <li class="list-group-item"><h5><p style="margin-left:100px;">Name: <?php echo $name;?></p> </h5></li>
  <li class="list-group-item"><h5><p style="margin-left:100px;">Email: <?php echo $email;?></p></h5></li>
  <li class="list-group-item"><h5><p style="margin-left:100px;">Phone: <?php echo $phone;?></p></h5></li>
  <li class="list-group-item"><h5><p style="margin-left:100px;">City: <?php echo $city;?></p></h5></li>
  <li class="list-group-item"><h5><p style="margin-left:100px;">Date Of Birth: <?php echo $dob;?></p> </h5></li>
</ul>
<br>
<center>
<h4><b>To Update Your Profile <a href="update.php">Click Here</a></b></h4>
</center>
